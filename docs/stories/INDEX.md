...
description: Índice programático das histórias de usuário.
area: product
tags: [index, product]
...
|---|---|---|---|---|
| US-001 | [👤 US-001 - Cadastro de Usuário](./US-001-register-user.md) | Documento de product do projeto LIA. | product | product, us-001-register-user |
| US-002 | [👤 User Story](./US-002-login.md) | Documento de product do projeto LIA. | product | product, us-002-login |
